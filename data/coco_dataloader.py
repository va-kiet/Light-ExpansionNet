...
class CocoDataLoader(TransparentDataLoader):
    ...
    def get_next_batch(self, verbose=False, get_also_image_idxes=False, get_also_image_path=False):
        ...
        if self.batch_it[0] >= self.num_batches:
            if verbose:
        ...
        img_id_batch = []
        img_idx_batch = self.image_idx_x[0][self.batch_it[0]]
        ...
        if self.dataloader_mode == 'caption_wise':
            batch_caption_y_as_string = copy.copy(self.caption_y[0][self.batch_it[0]])
        ...
        if verbose:
            ...
            print(str(self.rank) + "] " + __name__ + ") batch " + str(self.batch_it[0]) + " / " +
    ...
    def set_batch_it(self, batch_it):
        self.batch_it[0] = batch_it

    def get_batch_it(self):
        return self.batch_it[0]
    ...
    def save_state(self):
        return {'batch_it': self.batch_it[0],
    ...
    def load_state(self, state):
        ...
        self.batch_it[0] = state['batch_it']
